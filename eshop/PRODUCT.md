...
- Zákazníci, jejichž vlajky jsou vidět na fotkách v `public/fotky/`: Race the Streets, Zápal to! Crew, aretacni-pripravky.cz (AP), PAME-Ostrava s.r.o., dále F-Power Tires, Drifter.sk, Amerika Cars, Apex Invest. Jména firem jsou tedy ověřená (jsou přímo na vlajkách), **znění citací na homepage ale ověřené není** — 9. 9. 2026 je napsal Claude jako placeholder na zadání uživatele a čeká na potvrzení od každé firmy (viz `src/components/HomeReferences.tsx`). Do potvrzení je nesmí nikdo brát jako skutečný citát; fabrikovaná recenze je nekalá obchodní praktika.
...
5. Reference jmenují jen firmy, které jsou skutečně vidět na fotkách z akcí; znění citací musí před spuštěním potvrdit sám zákazník. Žádná fabrikovaná klientská loga ani čísla nad rámec potvrzených (3500/10000/250).
